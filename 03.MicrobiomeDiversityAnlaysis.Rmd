...
Library(phyloseq microbiome, mia, ggplot2, dplyr, vegan)
############################################################
## 1. Load Data and perform betadiversity analysis
############################################################
```{r}
#rarified gero dataset
gero<-read_rds("gero_rare.rds")
